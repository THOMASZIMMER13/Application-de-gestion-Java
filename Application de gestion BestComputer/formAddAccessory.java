...
import java.awt.*;
import javax.swing.*;
public class formAddAccessory extends JFrame implements ActionListener {


    private Connection conn;    //attribut qui memorise la connexion a la base

private JLabel labInventory, labBrand, labModel, labTitle, labDescription, labPrice, labSerialnumber, labReleaseDate;

private JTextField jtfInventory, jtfBrand, jtfModel, jtfTitle, jtfPrice, jtfSerialnumber, jtfReleaseDate;
...
public formAddAccessory (){
//setLayout(null); //empécher le positionnement automatique des fenetres
setDefaultCloseOperation(DISPOSE_ON_CLOSE);
		this.setTitle("Ajout d'un nouvel accessoire ou périphérique");
...
java.sql.Date releaseDate = java.sql.Date.valueOf(jtfReleaseDate.getText());
        ...
        String sql = "INSERT INTO product(inventory, brand, model, title, description, price, serialnumber, releasedate, producttype) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
